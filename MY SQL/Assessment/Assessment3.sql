...
alter table flights
add DepartureTerminal varchar(50);
update Flights
set DepartureTerminal='T1'
where Flightid= 1;
...
alter table Flights
add column GateNumber varchar(50);
update Flights
set GateNumber='A1';
